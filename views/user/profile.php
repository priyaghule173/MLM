              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo base_url('insertnewjoin/'); ?>" method="post" novalidate>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="sponsor_id">Sponsor ID <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="sponsor_id" class="form-control col-md-7 col-xs-12"  name="sponsor_id" placeholder="Sponsor ID" value="<?php echo $this->session->userdata('member_code'); ?>" required="required" type="text">
                        </div>
                      </div>
                     ...
                     <!--  <div class="item form-group">
                      ...
                      <!-- bank details of whom to pay -->

                       <div class="x_title">
                       <h2> Joining Payment Details</h2>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="joining_paid_by" class=" form-control col-md-7 col-xs-12"  name="joining_paid_by"  required="required"   type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="joining_account_no" class=" form-control col-md-7 col-xs-12"  name="joining_account_no"  required="required"   type="text">
                        </div>
                      </div>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="branch_name">Transaction ID<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="transaction_id" class=" form-control col-md-7 col-xs-12"  name="transaction_id"  required="required"   type="text">
                        </div>
                      </div>
                      ...
                      <!-- end bank details of whom to pay -->
